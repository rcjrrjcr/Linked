...
public class LinkedBlockListener extends BlockListener {
    ...
    /**
	 * Redirect certain events (to more separate the two distinct functions they are used for)
	 */
    @Override
    ...
    public void onBlockInteract(BlockInteractEvent event) {
    	...
    	if (b.getType() == Material.CHEST) {
    		...
    		if (plugin.chestNames.containsKey(b)) {
				...
				ep.a(virtChest); // ep.a is a obfuscated method name. It will show the virtual chest to the player.
